...
try:
    ...
    print(e)
    print('squad_client is needed if you want to upload to qa-reports')
    ...
    def send_to_qa_reports(self):
        ...
        for metric in self.metrics:
            if metric['measurement'] != "":
                metrics["{}".format(metric['test_case_id'])] = metric['measurement']
            else:
                tests["{}".format(metric['test_case_id'])] = metric['result']
